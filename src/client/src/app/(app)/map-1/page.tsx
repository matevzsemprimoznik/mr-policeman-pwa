...
export default function Home() {
  ...
  const getModalContent = (content: ModalContent): ReactNode => {
    switch (content) {
      case ModalContent.CONTRIBUTION_FORM:
        return <ControlForm latitude={coordinates.latitude} longitude={coordinates.longitude} setModalOpen={setModalOpen} />;
  ...
  return (
    <div className="w-full relative">
      <Button className='bg-muted hover:bg-muted text-white absolute top-4 left-4 z-50' onClick={handleAddControlClick}>Dodaj kontrolo</Button>
